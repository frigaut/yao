           ...
           
{
  ...
  */
  ...
  gnoise2      = ( float* ) malloc ( nb2 * sizeof ( float ) );
  ...
  if ( A == NULL || K == NULL || result == NULL || 
       bimage == NULL || bimage2 == NULL || simage == NULL || 
       brayleigh == NULL || gnoise2 == NULL || bsubmask == NULL ||
       fnoise == NULL ) { return (1); }
